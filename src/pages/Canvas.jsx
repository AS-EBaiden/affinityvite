  ...
  return (
    <>
      <Box style={{ display: "flex", flexWrap: "wrap" }}>
        <div
          style={{ flex: " 0 0 75%", maxWidth: " 75%", marginBottom: "2rem" }}
        >
          <H1>Dashboard</H1>
        </div>
      ...
      <DragDrop>
        ...
        <Tile m={12}>
          ...
          <P>
            Looking for a report? If you know the name of it, you can search by
      ...
      >
        ...
        <Box p={4}>
          ...
          can serve you better, please let us know. We appreciate your time and
          commitment to helping us refine our services for everyone.
        </Box>
      </Box>
    </>
  );
