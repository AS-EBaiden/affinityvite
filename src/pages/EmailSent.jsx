...
import { Anchor, Box, H2, P, ButtonGroup, ButtonAnchor, ButtonUnstyled, Span } from '@allied-solutions/affinity'
  ...
  return (
    <>
      ...
      <P textAlign="left" typeStyle="bodySmall">
        We've received your request to reset your password. Please check your email for instructions on how to complete
        the process.
      </P>
      <P textAlign="left" typeStyle="caption">
        Didn’t receive the email? That’s ok, click{' '}
        <StyledAnchorLink as={Link} to={'/newpassword'} typeStyle="caption" fontWeight="500" color="blue">
          send again
        </StyledAnchorLink>{' '}
        to or{' '}
        <StyledAnchorLink
